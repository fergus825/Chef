...
public class LoreAdapter extends RecyclerView.Adapter<LoreAdapter.Holder>{
    private Context mContext;
    private List<HomePageBean.DatasBean.ArticleListBean> mDatas;
    private OnItemClickListener mListener;
    private RecyclerView mRecyclerView;
    private boolean isLoading;
    public LoreAdapter(Context context, RecyclerView recyclerView){
        mContext=context;
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mContext).inflate(R.layout.item_homepage_lore,parent,false);
    ...
    public void onBindViewHolder(Holder holder, final int position) {
        ...
        myHolder.question.setText(mDatas.get(position).getArticle_abstract());
        myHolder.answer.setText(mDatas.get(position).getArticle_title());
    ...
    class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(View itemView) {
            ...
            picture= (ImageView) itemView.findViewById(R.id.iv_img_lore);
        }
    }
